    ...
    while True:
        ...
        if button == 'Speak':
            ...
            if statement==0:
                ...
                speak('your personal assistant Spyro is shutting down,Good bye')
                print('your personal assistant Spyro is shutting down,Good bye')
                break
                ...
                speak('I am Spyro version 1 point O your persoanl assistant. I am programmed to minor tasks like'
                ...
                print('I am Spyro version 1 point O your persoanl assistant. I am programmed to minor tasks like'
                      'opening youtube,google chrome,gmail and facebook ,predict time,take a photo,search wikipedia, predict weather' 
                      'in different cities , get top headline news from CNN and you can ask me computational or geographical questions too!')
        ...
        if button == 'Type':
            ...
            sg.popup('About:', 'Created by Adrijan P.', 'Artificial Intelligence:'+'\n\n'+'Spyro', 'Version 1.0')
